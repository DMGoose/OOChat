◦ Developed a responsive user interface using React, enabling features like real-time message updates anddynamic chat windows that automatically adjust to various screen sizes
